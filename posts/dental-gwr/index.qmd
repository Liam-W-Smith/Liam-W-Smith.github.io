...
author: Liam Smith
date: '2021-12-18'
description: "Using geographically weighted regression to analyze social predictors and spatial variation of pediatric dental extractions in the United Kingdom."
format: html
categories:
    - GIScience
    - R
image: assets/adaptive_kernel_gwr.png
alisases:
  - https://liam-w-smith.github.io/dental-gwr
---
...
![](assets/adaptive_kernel_gwr.png)
...
I decided to follow the approach presented in section 9.6.7 of this ["Spatial Modelling for Data Scientists" tutorial](https://gdsl-ul.github.io/san/09-gwr.html).
...
![Figure 1: Coefficients and their statistical significance for percent children. n = 127 local authorities with statistically significant results.](assets/children-merged.png)

### Percent Disability

![Figure 2: Coefficients and their statistical significance for percent with disability. n = 96 local authorities with statistically significant results.](assets/disability-merged.png)

### Foreign Rate

![Figure 3: Coefficients and their statistical significance for percent foreign-born. n = 131 local authorities with statistically significant results.](assets/foreign-merged.png)

### Unemployment Rate

![Figure 4: Coefficients and their statistical significance for the unemployment rate. n = 30 local authorities with statistically significant results.](assets/unemployment-merged.png)
:::

I also created the following maps to illustrate the accuracy of the model's predictions.

![Figure 5: Actual extraction rates, predicted extraction rates, and associated R-Squared values.](assets/extractions-fullmerge.png)
...
- [Handout](assets/Conditions_for_Linear_Regression.pdf) from my data science class on the conditions for linear regression
- GWR Tutorials:
  - [https://gdsl-ul.github.io/san/09-gwr.html](https://gdsl-ul.github.io/san/09-gwr.html)
