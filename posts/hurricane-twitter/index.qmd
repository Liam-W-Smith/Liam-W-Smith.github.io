...
author: Liam Smith
date: '2021-11-28'
description: "Analyzing spatial patterns in Twitter activity during a natural disaster."
format: html
categories:
    - GIScience
    - R
image: assets/maps/G_Score_Ida.png
---
...
In this investigation, I conduct a replication of his work, applying a similar methodology to Twitter data collected during Hurricane Ida.
...
I also extend the analysis in new directions by conducting a temporal analysis of Twitter hotspots, a temporal analysis of the sentiments of Tweets, and a network analysis of retweet activity.
...
- [Baseline status ID's, November 2021](https://github.com/Liam-W-Smith/Dorian-Replication/blob/main/data/raw/public/control_raw.txt)
...
If you would like to see the complete code used for this study, you can [click here](https://github.com/Liam-W-Smith/Dorian-Replication/blob/main/procedure/code/01-ida.Rmd),
...
![Figure 1: Tweets relating to Hurricane Ida over the course of the study timeframe.](assets/figures/temporal.png)

#### Content Analysis

![Figure 2: The most common words in tweets relating to Hurricane Ida.](assets/figures/content_analysis3.png)

#### Word Network

![Figure 3: Network of word pairs in tweets relating to Hurricane Ida.](assets/figures/word_network2.png)

#### NTDI

![Figure 4: Increased Twitter activity illustrated by a Normalized Tweet Difference Index.](assets/maps/ntdi_ida.png)

#### Tweet Hotspots
![Figure 5: Hotspots of Twitter activity found with Local Getis-Ord statistic, August 29 - September 10.](assets/maps/G_Score_Ida.png)
:::
...
![Figure 6a: Temporal analysis of hotspots of Twitter activity found with Local Getis-Ord statistic, August 29 - 31.](assets/maps/G_Score_Ida1.png)

##### September 1 - 3

![Figure 6b: Temporal analysis of hotspots of Twitter activity found with Local Getis-Ord statistic, September 1 - 3.](assets/maps/G_Score_Ida2.png)

##### September 4 - 10

![Figure 6c: Temporal analysis of hotspots of Twitter activity found with Local Getis-Ord statistic, September 4 - 10.](assets/maps/G_Score_Ida3.3.png)
:::
...
![Figure 7a: Sentiment analyses of Twitter activity at different times during the disaster, August 29 - 31.](assets/figures/sentiment_analysis1.png)

##### September 1 - 3

![Figure 7b: Sentiment analyses of Twitter activity at different times during the disaster, September 1 - 3.](assets/figures/sentiment_analysis2.png)

##### September 4 - 10

![Figure 7c: Sentiment analyses of Twitter activity at different times during the disaster, September 4 - 10.](assets/figures/sentiment_analysis3.png)
:::

#### Retweet Network

![Figure 8: Retweet and quote network.](assets/figures/network.png)
