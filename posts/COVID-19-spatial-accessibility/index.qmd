...
author: Liam Smith
date: '2021-11-08'
description: "Reproducing and revising a study on accessibility of healthcare resources necessary to address COVID-19 in Chicago."
format: html
categories:
    - GIScience
    - Python
image: assets/Kang_Class_Reproduction/pop_vents_class.png
---
...
![Accessibility of ICU Beds to vulnerable populations, as produced by GEOG 323 Spring 2021.](assets/Kang_OG_Reproduction/pop_icu_class.png){width=80%}

#### Updated Figure

![Accessibility of ICU Beds to vulnerable populations, updated fall 2021.](assets/Kang_Class_Reproduction/pop_icu_class.png){width=80%}
...
![Accessibility of ventilators to vulnerable populations, as produced by GEOG 323 Spring 2021.](assets/Kang_OG_Reproduction/pop_vents_class.png){width=80%}

#### Updated Figure

![Accessibility of ventilators to vulnerable populations, updated fall 2021.](assets/Kang_Class_Reproduction/pop_vents_class.png){width=80%}
